              ...
              <div className="auth-mockup__body">
                <div className="auth-mockup__left">
                  ...
                  <div className="auth-mockup__tabs">
                    {["Images", "Vidéo", "Audio"].map(t => (
                      <span key={t} className="auth-mockup__tab">{t}</span>
                    ))}
                  </div>
                  <div className="auth-mockup__player">
                    <div className="auth-mockup__play">▶</div>
                    <div className="auth-mockup__bar2">
                      <div className="auth-mockup__progress" />
                    </div>
                  </div>
                </div>
                <div className="auth-mockup__right">
                  <div className="auth-mockup__stats">
                    <div className="auth-mockup__stat">
                      <div className="auth-mockup__stat-label">MODÈLES</div>
                      <div className="auth-mockup__stat-value">50+</div>
                    </div>
                    <div className="auth-mockup__stat">
                      <div className="auth-mockup__stat-label">CRÉDITS</div>
        ...
        <div className="auth-right">
          <div className="auth-form-wrap">
            ...
            <div className="auth-form">
              ...
              <button className="auth-btn auth-btn--primary">Se connecter →</button>
              ...
              <p className="auth-switch">
                Pas de compte ? <Link href="/register" className="auth-link">S&apos;inscrire</Link>
              </p>
            </div>
          </div>
        </div>
...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-input { background: #111120; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: 12px 14px; color: #fff; font-size: 14px; font-family: inherit; outline: none; transition: border-color .2s; }
  .auth-input:focus { border-color: var(--accent); }
  .auth-input::placeholder { color: #444; }
  .auth-btn { padding: 13px 20px; border-radius: 8px; font-size: 15px; font-weight: 600; cursor: pointer; border: none; font-family: inherit; transition: all .2s; display: flex; align-items: center; justify-content: center; gap: 8px; }
